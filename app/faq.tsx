    ...
    <View style={tw`bg-white dark:bg-neutral-800 rounded-[16px] border border-neutral-200 dark:border-neutral-700 mb-3 overflow-hidden`}>
      ...
      {isExpanded && (
        <View style={tw`px-5 pb-5`}>
          <AppText style={tw`text-[15px] text-neutral-600 dark:text-neutral-400 leading-6`}>{answer}</AppText>
        </View>
      )}
    </View>
  );
...
const faqData = [
  {
    ...
    answer: "Eklan is an AI-powered English learning application designed to help you improve your pronunciation, speaking confidence, and overall English fluency through personalized lessons and real-time feedback.",
  },
  {
    question: "Who can use eklan?",
    answer: "Eklan is designed for anyone looking to improve their English skills, from beginners to advanced learners. It's particularly helpful for non-native speakers who want to work on their pronunciation and speaking confidence.",
  },
  {
    question: "How does eklan improve my pronunciation?",
    answer: "Eklan uses advanced AI speech recognition technology to analyze your pronunciation in real-time. It identifies specific sounds you need to work on and provides targeted exercises and feedback to help you improve.",
  },
  {
    question: "What makes eklan different from other English learning apps?",
    answer: "Eklan focuses specifically on pronunciation and speaking confidence, using AI to provide personalized feedback. Unlike other apps that focus on vocabulary or grammar, we help you sound more natural and confident when speaking English.",
  },
  {
    question: "Do I need to be fluent in English to use eklan?",
    answer: "No! Eklan is designed for learners at all levels. Whether you're just starting out or looking to refine your advanced skills, our AI adapts to your level and provides appropriate exercises.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes! Our AI is trained on a diverse range of accents and can understand and provide feedback for speakers from various linguistic backgrounds.",
  },
  {
    question: "Does Eklan store my voice recordings?",
    answer: "Your voice recordings are processed in real-time to provide feedback and are not permanently stored. We take your privacy seriously and you can review our privacy policy for more details.",
  },
  {
...
export default function FAQScreen() {
  ...
  const handleContactSupport = () => Linking.openURL("mailto:support@eklanAI.com");
  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-white dark:bg-neutral-900`} edges={["top", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={tw`px-6 pb-6 pt-2`} showsVerticalScrollIndicator={false}>
        {/* Intro */}
        <View style={tw`mb-8`}>
          <AppText style={tw`text-[28px] font-bold text-neutral-900 dark:text-white mb-4`}>FAQs</AppText>
          <AppText style={tw`text-[15px] text-neutral-900 dark:text-neutral-300 leading-[22px]`}>
            ...
            <AppText style={tw`text-blue-500 dark:text-blue-400`} onPress={handleContactSupport}>
              support@eklanAI.com
            </AppText>{" "}
            we're here to help!
          </AppText>
